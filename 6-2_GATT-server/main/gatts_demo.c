...
#define TEST_DEVICE_NAME            "ESP_GATTS_DEMO"    //设备名称
...
static esp_ble_adv_params_t adv_params = {
    .adv_int_min        = 0x20, //最小连接间隔
    .adv_int_max        = 0x40, //最大连接间隔
...
#define PROFILE_A_APP_ID 0  //服务a
#define PROFILE_B_APP_ID 1  //服务b
...
static void gatts_profile_a_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param) {
    ...
    case ESP_GATTS_CONNECT_EVT: {
        ...
        conn_params.max_int = 0x20;    // max_int = 0x20*1.25ms = 40ms，最大连接间隔
        conn_params.min_int = 0x10;    // min_int = 0x10*1.25ms = 20ms，最小连接间隔
...
// gatt 服务 b 的事件回调，与服务 a 类似，内容基本与a服务一致
static void gatts_profile_b_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param) {
    switch (event) {
    case ESP_GATTS_REG_EVT:
        ESP_LOGI(GATTS_TAG, "REGISTER_APP_EVT, status %d, app_id %d\n", param->reg.status, param->reg.app_id);
...
void app_main(void)
{
    ...
    // 注册gatt server 服务回调，uuid不同回调处理不同
